...
const QUESTIONS = [
  ...
  { text: "Identify the place.", hint: "This place is in Punjab and became a powerful symbol of the freedom struggle after a tragic event in 1919.", image: "/images/q3.jpg", answer: "Jallianwala Bagh" },
  ...
  { text: "Identify this place.", hint: "This historic monument in the heart of Delhi has witnessed the hoisting of the Indian national flag on Independence Day since 1947.", image: "/images/q6.jpg", answer: "Red Fort" },
  { text: "Who was the first Indian woman president of the Indian National Congress?", answer: "Sarojini Naidu" },
  { text: "Who is the freedom fighter shown in these historic photographs?", hint: "His journey took him from Calcutta to Germany and later to Southeast Asia, where he played a major role in India's struggle for independence.", image: "/images/q8.jpg", answer: "Subhas Chandra Bose" },
  { text: "What historic movement is captured in these photographs?", hint: "It began in Gujarat and covered roughly 390 km on foot, challenging a British law that affected something found abundantly along India's coastline.", image: "/images/q9.jpg", answer: "Dandi March / Salt March" },
