...
socket.on("phase",q=>{if(role!=="participant")return;
  if(q.phase==="countdown"){showParticipantPanel("countdownPanel");runPhaseTimer(q.startedAt,q.durationMs,"countdownNumber",null);}
  else if(q.phase==="letsStart"){showParticipantPanel("letsStartPanel");setTimeout(()=>startTicking(),100);}
